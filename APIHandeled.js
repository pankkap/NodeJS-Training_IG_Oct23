const api_url =
  "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/noida?key=4F5UJPBN3FA7KA3VU8S75TWHZ";
...
function handleForm() {
  ...
  updateWeatherInfo(daysTempData, output);
}
